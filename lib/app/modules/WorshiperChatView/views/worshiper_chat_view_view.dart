...
class WorshiperChatViewView extends GetView<WorshiperChatViewController> {
  const WorshiperChatViewView({super.key});
                  ...
                  return Padding(
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          Get.toNamed(Routes.WORSHIPER_CHAT_WITH_LEADERS,
                              arguments: {
                                'leaderId': c.otherUserId,
        'leaderName': c.name,
        'leaderPhoto': c.profilePhoto,
                              }
